...
export default function GlobalError({ error, reset }) {
  ...
  return (
    <div className="relative h-screen flex items-center justify-center bg-[#020617] overflow-hidden text-white px-4">
      ...
      {/* 🌌 Background Gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-red-900 via-black to-indigo-900 opacity-80" />
      ...
      >
        ...
        {/* ❌ Error Title */}
        <h1 className="text-5xl font-extrabold bg-gradient-to-r from-red-400 to-pink-500 bg-clip-text text-transparent">
        ...
        <div className="mt-6 flex gap-4 justify-center">
          <button
            onClick={() => reset()}
            className="px-6 py-2 rounded-xl bg-gradient-to-r from-red-500 to-pink-500 hover:scale-105 transition-all shadow-lg"
          >
            Try Again
          </button>
