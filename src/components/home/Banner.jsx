...
function SampleNextArrow(props) {
  const { onClick } = props;
  return (
    <div className="hidden lg:block absolute h-10 w-10 bg-secondary rounded-full  text-[#fff] top-[50%] translate-y-[-50%] 2xl:-right-20 -right-2.5  cursor-pointer z-10 duration-300 ease-in-out  hover:bg-[#0A472E]" onClick={onClick}>
...
function SamplePrevArrow(props) {
  const { onClick } = props;
  return (
    <div className="hidden lg:block absolute h-10 w-10 bg-secondary rounded-full  text-[#fff] top-[50%] translate-y-[-50%] 2xl:-left-20 -left-2.5  cursor-pointer z-10 duration-300 ease-in-out  hover:bg-[#0A472E]" onClick={onClick}>
      ...
      <section className='pt-30 lg:pb-40 pb-20 px-2 bg-[#F7F5EB] relative'>
        ...
        <Container>
          <div className=" relative">
            <Slider {...settings}>
              <div className="">
                <div className=" lg:flex justify-between items-center relative z-10 px-3">
                  <div className="">
                    <div className="flex items-center">
                      <Image className='' src={herb} alt="herb" />
                      <h5 className='text-[18px] font-nunito font-bold text-primary'>100% genuine Products</h5>
                    </div>
                    <div className="">
                      <h2 className='lg:text-[70px] text-[40px] font-inter font-bold text-primary leading-[120%]'>Tasty & Healthy organic Food</h2>
                  ...
                  <div className="">
                    <Image className="lg:w-full w-[80%]" src={slider01} alt="herb" />
                  </div>
                </div>
              </div>
              <div className="">
            ...
            <div className="py-5.75 px-16.75 bg-white lg:flex justify-between items-center shadow-md absolute lg:-bottom-60 -bottom-160 left-0 w-full">
              <div className="relative pr-10 lg:after:absolute after:content-[''] after:w-0.5 after:h-full after:bg-[#707070] after:bottom-0 after:right-0 after:duration-300 after:ease-in-out lg:mt-0 mt-5 ">
